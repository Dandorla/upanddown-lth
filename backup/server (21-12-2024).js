      ...
      res.send(`
        <html>
            ...
            <body>
                ...
                <button onclick="window.location.href='/record/${CF}'">Torna Indietro</button>
            </body>
        </html>
    `);
  });
  ...
  db.run(updateQuery, [CF], function (err) {
    ...
    res.send(`
      <html>
        ...
        <body>
          <h1>Aggiornamento completato</h1>
          <button onclick="window.location.href = '/record/${CF}?updated=true';">Torna Indietro e Ricarica</button>
        </body>
      </html>
    `);
  });
                      ...
                      res.send(`
                          <html>
                              ...
                              <body>
                                  ...
                                  <button onclick="window.location.href = '/record/${CF}';">Torna alla Pagina Utente</button>
                              </body>
                          </html>
                      `);
                  });
